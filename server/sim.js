...
const HERO_BASE={
  ...
  cacklefang:{swing:1.8,hp:245,dmg:36,apow:0,role:'Marksman',stars:2,healer:false,atkSpeed:1.0},
  calypsa:{swing:1.8,hp:240,dmg:36,apow:24,hybrid:true,role:'Marksman',stars:2,healer:false,atkSpeed:1.1},
  cardwraith:{swing:1.9,hp:230,dmg:40,apow:0,role:'Assassin',stars:2,healer:false,atkSpeed:0.95},
  chainwheel:{swing:1.8,hp:560,dmg:26,apow:0,role:'Tank',stars:3,healer:false,atkSpeed:1.0},
  deepcleft:{swing:1.8,hp:400,dmg:36,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:0.95},
  greatbrow:{swing:1.8,hp:620,dmg:24,apow:0,role:'Tank',stars:3,healer:false,atkSpeed:0.9},
  ironcoil:{swing:1.8,hp:600,dmg:26,apow:0,role:'Tank',stars:3,healer:false,atkSpeed:0.95},
  kharos:{swing:1.8,hp:275,dmg:46,apow:0,role:'Assassin',stars:3,healer:false,atkSpeed:1.25},
  kilnmask:{swing:1.8,hp:370,dmg:40,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:1.0},
  lysara:{swing:1.8,hp:195,dmg:16,apow:32,role:'Mage',stars:2,healer:false,atkSpeed:0.95},
  nerisse:{swing:1.8,hp:215,dmg:14,apow:30,role:'Support',stars:2,healer:true,atkSpeed:0.95},
  nox:{swing:1.8,hp:245,dmg:40,apow:0,role:'Assassin',stars:2,healer:false,atkSpeed:1.2},
  orryn:{swing:1.8,hp:195,dmg:18,apow:34,role:'Mage',stars:3,healer:false,atkSpeed:1.05},
  pellucid:{swing:1.8,hp:580,dmg:25,apow:0,role:'Tank',stars:3,healer:false,atkSpeed:0.95},
  silkcoil:{swing:1.8,hp:255,dmg:39,apow:0,role:'Assassin',stars:2,healer:false,atkSpeed:1.15},
  threadseer:{swing:1.6,hp:220,dmg:14,apow:31,role:'Support',stars:2,healer:true,atkSpeed:1.15},
  vaelora:{swing:1.8,hp:230,dmg:16,apow:32,role:'Mage',stars:3,healer:true,atkSpeed:1.0},
  velvetplum:{swing:1.8,hp:250,dmg:16,apow:32,role:'Support',stars:3,healer:true,atkSpeed:1.25},
  veyr:{swing:1.8,hp:310,dmg:44,apow:34,role:'Assassin',stars:3,healer:false,atkSpeed:1.2},
  zahri:{swing:1.8,hp:320,dmg:44,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:1.05},

  konwu:{swing:1.9,hp:380,dmg:34,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:1.15},
  grosk:{swing:2.6,hp:620,dmg:18,apow:0,role:'Tank',stars:3,healer:false,atkSpeed:0.85},
  vulmar:{swing:2,hp:175,dmg:26,apow:30,role:'Mage',stars:3,healer:false,atkSpeed:0.85},   // v484: Vulmar gets Ability Power (casters scale off AP now)
  tick:{swing:2.2,hp:360,dmg:28,apow:0,role:'Bruiser',stars:1,healer:false,atkSpeed:1.1},
  sylthaine:{swing:2,hp:150,dmg:14,apow:32,role:'Mage',stars:1,healer:false,atkSpeed:0.85},
  aureth:{swing:2.4,hp:460,dmg:24,apow:24,role:'Bruiser',stars:3,healer:false,atkSpeed:0.9},
  bloatus:{swing:2.4,hp:540,dmg:24,apow:28,role:'Tank',stars:3,healer:false,atkSpeed:0.9},
  vireo:{swing:2,hp:220,dmg:16,apow:30,role:'Support',stars:1,healer:true,atkSpeed:0.9},
  fritz:{swing:1.8,hp:320,dmg:22,apow:30,role:'Mage',stars:2,healer:false,atkSpeed:1,armor:60,mr:90},
  umbris:{swing:2,hp:170,dmg:22,apow:32,role:'Mage',stars:3,healer:false,atkSpeed:0.85},
  vael:{swing:2.3,hp:400,dmg:30,apow:0,role:'Bruiser',stars:1,healer:false,atkSpeed:0.95},
  oakmir:{swing:2,hp:230,dmg:16,apow:32,role:'Support',stars:3,healer:true,atkSpeed:0.85},
  rhukk:{swing:2.4,hp:430,dmg:26,apow:0,role:'Bruiser',stars:2,healer:false,atkSpeed:0.9},
  hurne:{swing:2.5,hp:520,dmg:32,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:0.9},
  meridian:{swing:2,hp:200,dmg:34,apow:0,role:'Marksman',stars:3,healer:false,atkSpeed:1},
  tallow:{swing:2.6,hp:560,dmg:26,apow:0,role:'Tank',stars:2,healer:false,atkSpeed:0.85},
  astra:{swing:2,hp:180,dmg:16,apow:34,role:'Mage',stars:2,healer:false,atkSpeed:0.85},
  magistrant:{swing:2.2,hp:450,dmg:28,apow:0,role:'Bruiser',stars:2,healer:false,atkSpeed:1},
  vharn:{swing:2.3,hp:430,dmg:32,apow:0,role:'Bruiser',stars:2,healer:false,atkSpeed:0.95},
  fathom:{swing:2.2,hp:300,dmg:16,apow:30,role:'Mage',stars:2,healer:false,atkSpeed:0.85},
  lumi:{swing:2,hp:210,dmg:14,apow:30,role:'Support',stars:2,healer:true,atkSpeed:0.9},
  hollow:{swing:1.7,hp:360,dmg:40,apow:0,role:'Assassin',stars:3,healer:false,atkSpeed:1.2},
  sprocket:{swing:1.8,hp:380,dmg:30,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:1},
  carn:{swing:2.4,hp:410,dmg:34,apow:0,role:'Bruiser',stars:1,healer:false,atkSpeed:1.05},
  vesper:{swing:2,hp:190,dmg:16,apow:32,role:'Mage',stars:2,healer:false,atkSpeed:0.85},
  sablewick:{swing:2,hp:200,dmg:15,apow:31,role:'Support',stars:2,healer:false,atkSpeed:0.85},
  vex:{swing:1.8,hp:320,dmg:34,apow:0,role:'Assassin',stars:1,healer:false,atkSpeed:1.15},
  arrears:{swing:2.2,hp:360,dmg:28,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:0.85},
  meryln:{swing:2,hp:200,dmg:12,apow:30,role:'Support',stars:1,healer:true,atkSpeed:0.9},
  /* v332 — new heroes */
  pyroclast:{swing:2,hp:185,dmg:16,apow:34,role:'Mage',stars:2,healer:false,atkSpeed:0.85},
  stormwarden:{swing:2.3,hp:440,dmg:30,apow:0,role:'Bruiser',stars:2,healer:false,atkSpeed:1.0},
  verdantshade:{swing:2,hp:210,dmg:32,apow:0,role:'Marksman',stars:2,healer:false,atkSpeed:1.0},
  voidweaver:{swing:2,hp:175,dmg:18,apow:36,role:'Mage',stars:3,healer:false,atkSpeed:0.85},
  dawnbringer:{swing:2.5,hp:580,dmg:24,apow:20,role:'Tank',stars:3,healer:false,atkSpeed:0.9},
  cathedral:{swing:2.6,hp:620,dmg:20,apow:26,role:'Tank',stars:3,healer:false,atkSpeed:0.85},
  lastfurnace:{swing:2.4,hp:470,dmg:34,apow:0,role:'Bruiser',stars:3,healer:false,atkSpeed:0.95},
  beekeeper:{swing:2,hp:230,dmg:14,apow:32,role:'Support',stars:2,healer:true,atkSpeed:0.9},
  librarian:{swing:2.1,hp:200,dmg:16,apow:34,role:'Mage',stars:3,healer:false,atkSpeed:0.85},
  corsair:{swing:2,hp:220,dmg:33,apow:0,role:'Marksman',stars:2,healer:false,atkSpeed:1.05},
  waxenduchess:{swing:2,hp:190,dmg:17,apow:35,role:'Mage',stars:3,healer:false,atkSpeed:0.85}
};
