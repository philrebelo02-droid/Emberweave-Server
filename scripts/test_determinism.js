...
(async()=>{
  ...
  const r=await pg.evaluate(async()=>{
    ...
    const run=(seed)=>{ simFightResult(allies.map(a=>a.key), foes, seed);
    ...
    const d1=(()=>{ simFightResult(['vael','sylthaine'], foes, 4242); return window._p2digest; })();
    ...
    const c1=(()=>{ simFightResult(big, bigFoes, 777); return window._p2digest; })();
    const c2=(()=>{ simFightResult(big, bigFoes, 777); return window._p2digest; })();
