...
node --test tests/witches-hut.test.js tests/witches-hut-api.test.js tests/world-location.test.js tests/world-mines.test.js tests/world-mine-realtime.test.js tests/world-pvp-realtime.test.js || FAILED=1
